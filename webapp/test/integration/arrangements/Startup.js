sap.ui.define([
	"sap/ui/test/Opa5",
	"sap/ui/localService/mockserver"
], function (opaTest,  mockserver, ODataModel) {
	"use strict";

	return sap.ui.test.Opa5.extend("integration.arrangements.Startup", {
		 ...
		 */
		iStartMyApp2: function (oOptionsParameter) {
